...
# Constante para las opciones de meses (siempre serán 12)
MONTH_CHOICES = [
    ('01', 'Enero'),
    ('02', 'Febrero'),
    ('03', 'Marzo'),
...
class FiltroFecha(django_filters.FilterSet):
    def __init__(self, *args, **kwargs):
        ...
        self.filters['agno'].extra['choices'] = year_choices
    ...
    # El año se calculará dinámicamente a partir de los registros
    ...
    def filtro_por_mes(self, queryset, name, value):
        return queryset.filter(fecha_importe__month=value) if value else queryset
...
class HistorialRecibosFilter(django_filters.FilterSet):
    ...
    # Aquí se usan choices estáticos para el año; podrías hacerlo dinámico de forma similar a FiltroFecha
